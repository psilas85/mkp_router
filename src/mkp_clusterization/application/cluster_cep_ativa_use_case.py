#mkp_clusterization/application/cluster_cep_ativa_use_case.py
...
from mkp_clusterization.domain.centers_geolocation_service import CentersGeolocationService
...
class ClusterCEPAtivaUseCase:
    ...
    def execute(self):
        ...
        # ============================================================
        try:
            from mkp_clusteruzation.reporting.export_resumo_clusters_cep import (
