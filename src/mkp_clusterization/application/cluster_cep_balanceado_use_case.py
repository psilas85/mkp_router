#mkp_clusterization/application/cluster_cep_balanceado_use_case.py
...
class ClusterCEPBalanceadoUseCase(ClusterCEPAtivaUseCase):
    ...
    def execute(self):
        ...
        from mkp_clusterization.reporting.export_resumo_clusters_cep import exportar_resumo_clusters
