#sales_router/src/mkp_clusterization/api/cluster_api.py

# ============================================================
# 📦 src/mkp_clusterization/api/cluster_api.py
# ============================================================

from fastapi import FastAPI, Request
from fastapi.middleware.cors import CORSMiddleware
from fastapi.responses import JSONResponse
from mkp_clusterization.api.routes import router as cluster_router
import numpy as np
import json
import uvicorn
...
if __name__ == "__main__":
    uvicorn.run(
        "mkp_clusterization.api.cluster_api:app",
        host="0.0.0.0",
        port=8004,
        reload=True
    )
