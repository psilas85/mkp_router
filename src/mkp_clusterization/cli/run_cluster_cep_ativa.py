#mkp_router/src/mkp_clusterization/cli/run_cluster_cep_ativa.py

import argparse
import sys
from loguru import logger
from database.db_connection import get_connection
from mkp_clusterization.infrastructure.persistence.database_reader import DatabaseReader
from mkp_clusterization.infrastructure.persistence.database_writer import DatabaseWriter
from mkp_clusterization.application.cluster_cep_ativa_use_case import ClusterCEPAtivaUseCase
from mkp_clusterization.application.cluster_cep_balanceado_use_case import ClusterCEPBalanceadoUseCase
