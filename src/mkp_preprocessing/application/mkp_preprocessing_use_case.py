#mkp_router/src/mkp_preprocessing/application/mkp_preprocessing_use_case.py
...
from mkp_preprocessing.domain.validation_service import PDVValidationService
from mkp_preprocessing.domain.geolocation_service import GeolocationService
...
class PDVPreprocessingUseCase:
    ...
    def execute(self, input_path: str, sep=";"):
        ...
        try:
            ...
            # HISTÓRICO — INÍCIO
            # ============================================================
            self.writer.salvar_historico_mkp_job(
            ...
            inseridos = self.writer.inserir_mkps(pdvs)
